...
def funker19(a, b, c, d, e):
    answer = input(' Ваша страна столкнулась с серьезным экономическим кризисом из-за глобальных'
...
def rand4(a, b, c, d, e):
    print(
        '«Двести тысяч уже родилось, ещё миллион на подходе»:'
...
def rand6(a, b, c, d, e):
    print(
        'Сисадмин пролил кофе на сервер: глава материнского дата-центра Интернета'
        ' объяснил глобальный сбой в работе сети')
    return [a, b - 20, c, d - 10, e]


def rand7(a, b, c, d, e):
    print('Из алфавита уберут букву «Ў» после госпитализации туриста, пытавшегося её прочитать')
    return [a, b-10, c, d, e+20]


def rand8(a, b, c, d, e):
    print('Вы стали победителем The International 2024')
    return [a, b, c, d+20, e+10]


def rand9(a, b, c, d, e):
    print('Экоактивисты 15 раз облили супом картины в зале современного искусства, но этого никто так и не заметил')
    return [a, b, c, d+10, e-10]


def rand10(a, b, c, d, e):
    print('Был найден бункер с советским вооружением')
    return [a, b, c+20, d, e]


def rand11(a, b, c, d, e):
    print('«Своих не бросаем», — в стране запретили дзюдо')
    return [a, b, c+10, d+10, e+20]


def rand12(a, b, c, d, e):
    print('«Лучше греют»: эксперт объяснил преимущества ноутбуков отечественного производства')
    return [a, b, c, d+20, e+10]


def rand13(a, b, c, d, e):
    print('Наша сборная одержала победу на чемпионате мира по футболу')
...
def alliance(a, b, c, d, e, f, g, h, o, p):
    answer = input('Вашей стране предложили вступить в экономический союз' 
...
def sanctions(a, b, c, d, e, f, g, h, o, p):
    answer = input('Ваш союзник ввёл санкции против вашего государства.'
...
def branches(a, b, c, d, e, f, g, h, o, p):
    answer = input('Хотите расширить деятельность транснациональных компаний-гигантов'
...
def reparation(a, b, c, d, e, f, g, h, o, p):
    answer = input('Ваша страна проиграла в войне другой стране и вынуждена платить'
...
def military_bloc(a, b, c, d, e, f, g, h, o, p):
    answer = input('Вам предложили вступить в военный блок стран,'
                   'но тогда при возникновении войны вам придётся отправить в поддержку свою армию.'
                   '1 - Согласиться'
                   '0 - Отказаться')
    if answer == '1':
        print('К сожалению, началась мировая война.')
...
functions2 = {'funk_1': funkers1, 'funk_2': funkers2, 'funk_3': funkers3, 'funk_4': funkers4, 'funk_5': funkers5,
              ...
              'funk_11': rand6, 'funk_12': rand7, 'funk_13': rand8, 'funk_14': rand9, 'funk_15': rand10,
              'funk_16': rand11, 'funk_17': rand12, 'funk_18': rand13}
